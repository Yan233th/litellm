    ...
    async def mcp_provision_slack_app(
        ...
        provisioned = await provision_slack_app(
            ...
            manifest=build_slack_mcp_manifest(
                callback_url=callback_url, app_name=app_name, user_scopes=user_scopes
            ),
        )
        ...
        return {
            ...
            "next_steps": [
                ...
                "Publish the app to the directory, or make it internal and have a "
                "workspace admin approve it",
